                      ...
                      <div style="padding:4px;" id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                        <div class="row g-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="tin" name="tin" maxlength="16" style="height: 30px;" required>
                          </div>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="nopaspor" maxlength="16" name="nopaspor" style="height: 30px;" required>
                          </div>
                          <div class="col-md-4">
                            <label for="validationDefault03" class="form-label" style="font-size:14px;">No. KITAB/KITAS</label>
                            <input type="text" class="form-control" id="nokitab" name="nokitab" maxlength="11" style="height: 30px;" required>
                          </div>
                          <div class="col-md-12">
              ...
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordion">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <input class="form-control" oninput="generateDipotong()" id="jumlah_penghasilan_bruto" name="jumlah_penghasilan_bruto" style="height:30px;width:71%;" type="text" placeholder="" aria-label="default input">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <input class="form-control" style="height:30px; width:71%;" oninput="generateDipotong()" id="netto" name="netto" type="text" placeholder="" aria-label="default input">
                    </div>
                    <div style="padding: 3px;"></div>
                    <div class="row">
                      <div class="col-6" style="padding-left:4%;">
                      ...
                      <div class="col-6" style="padding-left:3%">
                        <input class="form-control" style="height:30px; width:75%;" id="tarif" name="tarif" style="height:30px;width:71%;" type="text" placeholder="" aria-label="default input">
                      </div>
                    </div>
                    <div style="padding: 3px;"></div>
                    <div class="row">
                      ...
                      <div class="col-6" style="padding-left:3%">
                        <input class="form-control" style="height:30px; width:75%;" id="jumlah_setor" name="jumlah_setor" style="height:30px;width:71%;" type="text" placeholder="" aria-label="default input">
                      </div>
                    </div>
                ...
                <div class="accordion-item">
                  <h6 class="accordion-header" id="headingFour">
                    <button id="identitaspemotong" class="accordion-button btn-warning" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  ...
                  <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordion">
                    <div class="accordion-body">
                      ...
                      <div class="col-md-4">
                        <label for="validationDefault04" class="form-label">Penandatangan
                          Bukti Potong</label>
                        <select name="pengaturan_id" class="form-select" id="pengaturan_id" required>
                    ...
                    <div class="row" style="padding-left: 57%; padding-right:55%;">
                      <div class="col">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                          ...
                          <button onclick="addTableHarta(this)" id="simpan" class="btn btn-outline-warning" disabled="true">Simpan</button>
...
<script>
  ...
  function generateDipotong() {
    ...
    //jumlah_setor.value = (parseInt(jumlah_penghasilan_bruto.value) * parseInt(netto.value) * percent);
    let raw_jumlah_penghasilan_bruto = parseInt(jumlah_penghasilan_bruto.value.split(",").join(''));
    let raw_netto = parseInt(netto.value.split(",").join(''));
    jumlah_penghasilan_bruto.value = numeral(raw_jumlah_penghasilan_bruto).format();
    jumlah_setor.value = formatPercent(raw_jumlah_penghasilan_bruto * raw_netto * percent);
    console.log(raw_jumlah_penghasilan_bruto, raw_netto, percent);
    netto.value = numeral(raw_netto).format();
    // if(document.getElementById("pilihdtp").checked = true || document.getElementById("pilihskd").checked = true){
    //   netto.value = 0;
...
<script>
  ...
  function addTableHarta($this) {
    ...
    $.ajax({
      type: "POST",
      url: `http://localhost:8000/api/tambahpphnon/${user_id}`,
      data: data,
