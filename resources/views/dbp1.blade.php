...
<body>
        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist" style="height:40px ; border-bottom:0px">
          <table>
            ...
            <tr>
                  ...
                  <td><button style="color: grey; padding: 8px 20px; text-align: center;" class="nav-link" id="dopp" onclick="dopp()" data-bs-toggle="tab" data-bs-target="#nav-dopp" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DOPP</button></td>
                  <td><button style="color: black; padding: 8px 20px; text-align: center;" id="dbp1" onclick="dbp1()" class="nav-link active" id="nav-bagian1-tab" data-bs-toggle="tab" data-bs-target="#nav-bagian1" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DBP Bagian 1</button></td>
                  <input type="hidden" id="tahun_pajak" value="{{ $tahun_pajak}}">
                  <input type="hidden" id="masa_pajak" value="{{ $masa_pajak}}">
                  <!-- <td><button style="color: grey; padding: 8px 20px; text-align: center;" class="nav-link" onclick="dbp()" data-bs-toggle="tab" data-bs-target="#nav-bagian2" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DBP Bagian 2</button></td> -->
        ...
        <div class="tab-content" id="nav-tabContent" style="margin-top: 40px">
          <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="table" ; style="background-color: rgb(4, 153, 195); height: 40px; padding: 10px 0px 10px 10px">
              <span style="color: white ; font-weight: bold; width: 25px">A. Daftar Bukti Pemungutan/Pemotongan Unifikasi Berformat Standar</span>
            </div>
            <div class="bodyproof">
              <table class="table" style="text-align: center">
                <thead>
                  <tr style="font-size: 13px; font-weight: 200; color: white; background-color: rgb(4, 153, 195); text-align: center">
                    ...
                    <td>NO BUKTI POTONG/PUNGUT</td>
                    <td>TANGGAL BUKTI POTONG/PUNGUT</td>
                    <td>JUMLAH DPP (RP)</td>
                    <td>JUMLAH PPH (RP)</td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr style="font-weight: 200; font-size: 15px; text-align: center;">
                    ...
                    <td>{{ $data['nomor_bukti'] ?? randomStringLetterNumber12Char(14) }}</td>
                    <td>{{ $data['tanggal_setor'] ?? date('Y-m-d',time())}}</td>
  ...
  function dbp() {
    ...
    var masa_pajak = document.getElementById("masa_pajak");
    // var oke = document.getElementById("oke");
    location.href = `dbp?tahun_pajak=${tahun_pajak.value}&masa_pajak=${masa_pajak.value}`
