...
<head>
  ...
  <title>Rekam PPh Sendiri | E-Bupot</title>
  <style>
    * {
            ...
            <form action="proses_tambah_pphsendiri" method="POST">
              ...
              <div class="container">
                ...
                <div class="row" style="padding-left: 15%; padding-right:15%;margin-bottom: 10px;">
                  ...
                  <div class="col">
                    <select name="kode_objek_pajak" id="kode_objek_pajak" class="abcd" style="width:90%">
                ...
                <div class="row" style="padding-left: 15%; padding-right:15%;margin-bottom: 10px;">
                  ...
                  <div class="container">
                    <div class="row" style="padding: 0% 0% 10% 52%">
                      <div class="col">
                        <button class="button button1" type="submit">
                          <span style="font-size: 18px" onclick="simpan()">Simpan</span></button>
