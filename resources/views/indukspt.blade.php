        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist" style="height:40px ; border-bottom:0px">
          <table>
            ...
            <tr>
                  ...
                  <td><button style="color: black; padding: 8px 20px; text-align: center;" class="nav-link active" id="indukspt" onclick="indukspt()" data-bs-toggle="tab" data-bs-target="#nav-induk" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Induk SPT</button></td>
              ...
              <table class="table" style="text-align: right">
                ...
                <tbody>
                  ...
                  <tr style="font-weight: 200; font-size: 13px; text-align: center;">
                    ...
                    <td>{{ number_format(((int) str_replace(",","",$kode28) + (int) str_replace(",","",$kode24)),2) }}</td>
                    <td>0,00</td>
                    <td>{{ number_format(((int) str_replace(",","",$kode28) + (int) str_replace(",","",$kode24)),2) }}</td>
                  </tr>
                </tbody>
            ...
            <table class="table" style="text-align: right; margin: 5px 0px 0px 0px">
              ...
              <tbody>
                ...
                <tr style="font-weight: 200; font-size: 13px; text-align: center;">
                  ...
                  <td>{{ number_format(((int) str_replace(",","",$kode28) + (int) str_replace(",","",$kode24) + (int) str_replace(",","",$kode22) + (int) str_replace(",","",$kode23)),0) }}</td>
                  <td>0,00</td>
                  <td>{{ number_format(((int) str_replace(",","",$kode28) + (int) str_replace(",","",$kode24) + (int) str_replace(",","",$kode22) + (int) str_replace(",","",$kode23)),0) }}</td>
                </tr>
                <tr style="font-weight: 200; font-size: 13px; text-align: center;">
