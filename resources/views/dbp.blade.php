            ...
            <table>
              <thead>
                <tr>
                  ...
                  <td><button style="color:black; padding: 8px 20px; text-align: center;" class="nav-link active" data-bs-toggle="tab" data-bs-target="#nav-bagian2" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DBP Bagian 2</button></td>
