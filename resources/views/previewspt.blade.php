...
<body>
  <div>
    <div>
      ...
      <div class='content' style="padding-top :20px; padding-left:330px; padding-right:250px">
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <td><a href="dopp?id={{ $id }}"><button style="color:grey; padding: 8px 20px; text-align: center;" class="nav-link" id="nav-dopp-tab" data-bs-toggle="tab" data-bs-target="#nav-dopp" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DOPP</button></a></td>
                    <td><button style="color:grey; padding: 8px 20px; text-align: center;" id="dbp1" onclick="dbp1()" class="nav-link" id="nav-bagian1-tab" data-bs-toggle="tab" data-bs-target="#nav-bagian1" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Lampiran DBP Bagian 1</button></a></td>
                          ...
                          <div class="row justify-content-start">
                            ...
                            <div class="container">
                              <div class="row justify-content-start">
                                ...
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[0]['jumlah_dpp'] }}" style="width: 70%;">
                                </div>
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[0]['jumlah_pph'] }}" style="width: 70%;">
                                </div>
                                ...
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[1]['jumlah_dpp'] }}" style="width: 70%;">
                                </div>
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[1]['jumlah_pph'] }}" style="width: 70%;">
                                </div>
                                ...
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[2]['jumlah_pph'] }}" style="width: 70%;">
                                </div>
                                ...
                                <div class="col-4" style="padding: 3px"></div>
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[3]['jumlah_pph'] }}"style="width: 70%;">
                                </div>
                                ...
                                <div class="col-4" style="padding: 3px"></div>
                                <div class="col-4" style="padding: 3px">
                                  <input type="text" placeholder="0" value="{{ $doss[4]['jumlah_pph'] }}" style="width: 70%;">
                                </div>
                              </div>
                            </div>
                          </div>
