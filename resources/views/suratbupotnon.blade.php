...
<head>
    ...
    <title>Surat Bukti Potong Non Residen</title>
    <style>
        .page {
            width: 210mm;
            min-height: 297mm;
    ...
    <div class="page">
        <div class="subpage">
                        ...
                        <div class="col-6" style="padding-left:10px;">
                            <table>
                                <tr style="text-align:center">
                                    <?php
                                    $Nomor = date('Ymd', time()) . str_pad(((int)$pphnon['id'] ?? 0), 3, '0', STR_PAD_LEFT);
                                    ?>
                        ...
                        <div class="input-group mb-6">
                            <div class="input-group-prepend">
                                <div class="row">
                                    ...
                                    <div class="col-1" style="border:1px solid black; width:10px; margin-left:14px; font-size: 10px">{{ (explode('-',$pphnon['kode_objek_pajak'] )[0] == 28 || explode('-',$pphnon['kode_objek_pajak'])[0] == 29) ? 'X' : '' }}</div>
            ...
            <div class="col-sm-12" style=" border: 1px solid black; background-color:cornsilk; padding: 6px 30px 4px 30px ; border: 2px solid">
                <div class="row">
                    <label class="col-6 col-form-label" style="font-size: 10px; font-weight:bold;">TIN</label>
                    <div class="col-6">
                        <input class="form-control" type="text" style="border: 1px solid black; height: 25px; border-radius: 1px; background:lavender; font-weight:bold; font-size: 10px" placeholder="{{ $pphnon['tin'] ?? '' }}" disabled="disabled">
                    </div>
                </div>
                <div class="row">
                    <label class="col-6 col-form-label" style="font-size: 10px; font-weight:bold;">NAMA</label>
                    <div class="col-6">
                        <input class="form-control" type="text" style="border: 1px solid black; height: 25px; border-radius: 1px; background:lavender; font-weight:bold; font-size: 10px" placeholder="{{ $pphnon['nama'] ?? '' }}" disabled="disabled">
                    </div>
                </div>
                <div class="row">
                    <label class="col-6 col-form-label" style="font-size: 10px;font-weight:bold;">ALAMAT</label>
                    <div class="col-6">
                        <input class="form-control" type="text" style="border: 1px solid black; height: 25px; border-radius : 1px; background:lavender; font-weight:bold; font-size: 10px" placeholder="{{ $pphnon['alamat'] ?? '' }}" disabled="disabled">
                    </div>
                </div>
                <div class="row">
                    <label class="col-6 col-form-label" style="font-size: 10px;font-weight:bold;">NEGARA</label>
                    <div class="col-6">
                        <input class="form-control" type="text" style="border: 1px solid black; height: 25px; border-radius : 1px; background:lavender; font-weight:bold; font-size: 10px" placeholder="{{ $pphnon['negara'] ?? '' }}" disabled="disabled">
                    </div>
                </div>
                <div class="row">
                    <label class="col-6 col-form-label" style="font-size: 10px;font-weight:bold;">NO. PASSPORT</label>
                    <div class="col-6">
                        <input class="form-control" type="text" style="border: 1px solid black; height: 25px; border-radius : 1px; background:lavender; font-weight:bold; font-size: 10px" placeholder="{{ $pphnon['no_paspor'] ?? '' }}" disabled="disabled">
                    </div>
                </div>
            </div>
            ...
            <table id="mytable" class="display">
                ...
                <tbody>
                    ...
                    <tr class="text" style="background-color:white; text-align:center;">
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px">{{ $pphnon['masa_pajak']  ?? '' }}</td>
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px">{{ $pphnon['kode_objek_pajak']  ?? '' }}</td>
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px">{{ $pphnon['jumlah_penghasilan_bruto']  ?? '' }}</td>
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px"><input class="text" style="width: 50%; border: 1px solid black"></td>
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px">{{ $pphnon['tarif']  ?? '' }}</small></td>
                        <td style="border:1px solid black; font-weight: bold; font-size: 9px">{{ $pphnon['jumlah_setor']  ?? '' }}</td>
                    </tr>
            </table>
            <div style="padding: 2px;"></div>
            <div class="row">
                ...
                <div class="col-4" style="font-weight:bold; font-size: 10px">:
                    <div class="col-4" style=" border-bottom:1px solid black; width:200%; margin-left: 10px">{{ $pphnon['objek_pajak']['nama_pajak']  ?? '' }}</div>
                </div>
                <div style="padding:2px;"></div>
                <div class="row">
                    <div style="font-size: 10px; font-weight:bold; padding-bottom: 4px">B.7 &ensp; Nomor Referensi : Nomor Dokumen <input class="text" style="font-size: 9px; font-weight: bold; width:25%; border:1px solid black" value="{{ $pphnon['no_dokumen'] ?? '' }}"></div>
                    {{-- <input class="text" style="width: 25%; margin-left: 9px; border: 1px solid black" value="{{ $dokumen_pphnon['no_dokumen'] ?? '' }}">
                </div> --}}
                <div style="font-size: 10px; font-weight:bold; padding:0px 0px 4px 77px; margin-left: 48px">Nama Dokumen <input class="text" style="margin-left: 5px; font-size: 9px; font-weight: bold; width: 27%; border: 1px solid black" value="{{ $pphnon['nama_dokumen'] ?? '' }}">
                    Tanggal<input class="text" style="font-size: 9px; font-weight: bold; width: 27%; margin-left: 10px; border: 1px solid black" value="{{ $pphnon['tgl_dokumen'] ?? '' }}"></div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    <div style="font-weight:bold; font-size:10px;">B.9 &ensp;
                        <input style="border:1px solid black; width:20px;font-weight: bold; font-size: 9px" value="<?= ($pphnon['fasilitas_pajak_penghasilan'] == 'surat keterangan bebas' ? 'X' : '') ?>">&ensp; PPh dibebankan berdasarkan Surat Keterangan Bebas(SKB).
                    </div>
                    <div class="row">
                        <div style="font-size:10px; font-weight:bold; padding-left: 65px; ">Nomor : &ensp;<input class="text" value="<?= (($pphnon['fasilitas_pajak_penghasilan'] == 'surat keterangan bebas' && $pphnon['no_fasilitas']) ? $pphnon['no_fasilitas'] : '') ?>" style="font-weight: bold; font-size: 9px; width:35%; border:1px solid black;">
                            Tanggal &ensp;<input class="text" value="{{ $pphnon['tgl_dokumen'] ?? '' }}" style="width:25%; border:1px solid black; font-weight: bold; font-size: 9px">
                        </div>
                    </div>
                </div>
                <div style="padding:4px;"></div>
                <div class="row">
                    <div style="font-weight:bold; font-size:10px;">B.10&ensp;
                        <input style="border:1px solid black; width:20px" value="<?= ($pphnon['fasilitas_pajak_penghasilan'] == 'pph ditanggung pemerintah' ? 'X' : '') ?>">&ensp; PPh yang ditanggung oleh pemerintah (DTP) berdasarkan :
                ...
                <div style="padding:4px;"></div>
                <div class="row">
                    <div style="font-weight:bold; font-size:10px">B.11&ensp;<input style="border:1px solid black; width: 20px" value="<?= ($pphnon['fasilitas_pajak_penghasilan'] == 'surat keterangan berdasarkan pp no 23' ? 'X' : '') ?>">&ensp;PPh dalam hal transaksi menggunakan Surat Keterangan berdasarkan PP Nomor 23 Tahun 2018 dengan Nomor :</div>
                    <div style="padding:8px;"></div>
            ...
            <div style="padding:4px;"></div>
            <div class="row">
                <div style="font-weight:bold; font-size:10px;">B.12&ensp;<input style="border:1px solid black; width:20px" value="<?= ($pphnon['fasilitas_pajak_penghasilan'] == 'fasilitas lainnya berdasarkan' ? 'X' : '') ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div style="font-size: 10px; font-weight:bold;">C.3&ensp; &ensp; &ensp;TANGGAL
                                    <input type="text" style="margin-left: 154px; font-size: 10px; border: 1px solid black; width: 31%; height: 20px; border-radius: 1px; background:lavender; font-weight: bold; font-size: 9px" value="{{ $pphnon['tgl_dokumen'] ?? '' }}" disabled="disabled">
                                </div>
                                <div style="padding: 4px"></div>
                                <div class="row">
                                    <div style="font-size: 10px; font-weight:bold;">C.4&ensp; &ensp; &ensp;NAMA PENANDATANGAN <input type="text" style="width: 32%; margin-left: 76px; font-size: 10px; border: 1px solid black; background:lavender; font-weight: bold; font-size: 9px" placeholder="{{ $pphnon['pengaturan']['nama']  ?? '' }}" disabled="disabled">
                                    </div>
                                </div>
                                <div style="padding: 4px"></div>
                                <div class="row">
                                    ...
                                    <div class="row" style="font-size: 10px; margin-left: 235px">
                                        <input style="border:1px solid black; width: 20px; font-size: 10px; background:lavender" value="<?= ($pphnon['kelebihan_pemotongan'] == 'pengembalian' ? 'X' : '') ?>">&ensp;Pengembalian atas kelebihan pembayaran pajak yang tidak seharusnya terutang oleh Pemotong <p style="margin-left: 17px">dan/atau Pemungut PPh </p>
                                    </div>
                                    <div class="row" style="font-size: 10px; margin-left: 235px">
                                    </div>
                                    <div class="row" style="font-size: 10px; margin-left: 235px">
                                        <input style="border:1px solid black; width: 20px; font-size: 10px; background:lavender" value="<?= ($pphnon['kelebihan_pemotongan'] == 'pemindahbukuan' ? 'X' : '') ?>">&ensp;Pemindahbukuan oleh Pemotong dan/ atau Pemungut PPh
                                    </div>
                                </div>
                            </div>
                        </div>
