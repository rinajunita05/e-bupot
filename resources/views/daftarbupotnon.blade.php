...
<head>
  ...
  <title>Daftar Bukti Potong PPh Non Residen | E-Bupot</title>
              ...
              <table class="table table-bordered">
                <div style="padding: 0px 15px;">
                  <table id="tabsendiri" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      @foreach ($daftarbupotnon as $data)
                      <tr class="text1" style="background-color: #FFFFFF;">
                        ...
                        <td>{{ $data['status'] }}</td>
                        <td>
                        <!--lihat bupot--> <a href="{{url('/suratbupotnon/'.$data['id']) }}">
                        ...
                        <!--edit--> <a href="{{url('/editpphnon/'.$data['id'])}}"> 
                        ...
                        <!--hapus--> <a href="{{url('/hapus_pphnon/'.$data['id'])}}">
