        ...
        <div class="tab-content" id="nav-tabContent" style="margin-top: 20px;">
          ...
          <div class="nav nav-tabs" id="nav-tab" role="tablist" style="height:40px ; border-bottom:0px">
            <table>
              <thead>
                <tr>
                  <td><button style="color: black; padding: 8px 20px; text-align: center;" class="nav-link active" id="" data-bs-toggle="tab" data-bs-target="#nav-doss" type="button" role="tab" aria-controls="nav-doss" aria-selected="false">Lampiran DOSS</button></td>
                        ...
                        <div class="row justify-content-start">
                          ...
                          <div class="container">
                            <div class="row justify-content-start">
                              ...
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[0]['jumlah_dpp'] ?? 0 }}" id="jumlah_dpp1" style="width: 70%;">
                              </div>
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[0]['jumlah_pph'] ?? 0 }}" id="jumlah_pph1" style="width: 70%;">
                              </div>
                              ...
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[1]['jumlah_dpp'] ?? 0 }}" id="jumlah_dpp2" style="width: 70%;">
                              </div>
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[1]['jumlah_pph'] ?? 0 }}" id="jumlah_pph2" style="width: 70%;">
                              </div>
                              ...
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[2]['jumlah_pph'] ?? 0 }}" id="jumlah_pph3" style="width: 70%;">
                              </div>
                              ...
                              <div class="col-4" style="padding: 3px"></div>
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[3]['jumlah_pph'] ?? 0 }}" id="jumlah_pph4" style="width: 70%;">
                              </div>
                              ...
                              <div class="col-4" style="padding: 3px"></div>
                              <div class="col-4" style="padding: 3px">
                                <input type="text" placeholder="0" value="{{ $doss[4]['jumlah_pph'] ?? 0}}" id="jumlah_pph5" style="width: 70%">
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
  ...
  function dopp() {
    ...
    // var oke = document.getElementById("oke");
    location.href = `dopp?id=${id.value}&tahun_pajak=${tahun_pajak.value}&masa_pajak=${masa_pajak.value}`
