                      ...
                      <div class="accordion-body">
                        ...
                        <div class="container">
                          <div class="row justify-content-start">
                            ...
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_dpp1" oninput="changeFormat()"  id="jumlah_dpp1" placeholder="0" style="width: 70%;">
                            </div>
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_pph1" oninput="changeFormat()" id="jumlah_pph1" placeholder="0" style="width: 70%;">
                            </div>
                            ...
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_dpp2" oninput="changeFormat()" id="jumlah_dpp2" placeholder="0" style="width: 70%;">
                            </div>
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_pph2" oninput="changeFormat()" id="jumlah_pph2" placeholder="0" style="width: 70%;">
                            </div>
                            ...
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_pph3" oninput="changeFormat()" id="jumlah_pph3" placeholder="0" style="width: 70%;">
                            </div>
                            ...
                            <div class="col-4" style="padding: 3px"></div>
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_pph4" oninput="changeFormat()" id="jumlah_pph4" placeholder="0" style="width: 70%;">
                            </div>
                            ...
                            <div class="col-4" style="padding: 3px"></div>
                            <div class="col-4" style="padding: 3px">
                              <input type="text" name="jumlah_pph5" oninput="changeFormat()" id="jumlah_pph5" placeholder="0" style="width: 70%;">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="container">
                        <div class="row justify-content-start">
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="hidden" name="pajak_penghasilan_id" oninput="changeFormat()" id="pajak_penghasilan_id" value="{{ $id}}">

                            <input type="text" name="jumlah_dpp6" oninput="changeFormat()" id="jumlah_dpp6" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph6" oninput="changeFormat()" id="jumlah_pph6" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp7" oninput="changeFormat()" id="jumlah_dpp7" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph7" oninput="changeFormat()" id="jumlah_pph7" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp8" oninput="changeFormat()" id="jumlah_dpp8" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph8" oninput="changeFormat()" id="jumlah_pph8" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp9" oninput="changeFormat()" id="jumlah_dpp9" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph9" oninput="changeFormat()" id="jumlah_pph9" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp10" oninput="changeFormat()" id="jumlah_dpp10" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp10" oninput="changeFormat()" id="jumlah_dpp10" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp11" oninput="changeFormat()" id="jumlah_dpp11" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph11" oninput="changeFormat()" id="jumlah_pph11" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp12" oninput="changeFormat()" id="jumlah_dpp12" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph13" oninput="changeFormat()" id="jumlah_pph13" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp14" oninput="changeFormat()" id="jumlah_dpp14" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph14" oninput="changeFormat()" id="jumlah_pph14" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp15" oninput="changeFormat()" id="jumlah_dpp15" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph15" oninput="changeFormat()" id="jumlah_pph15" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp16" oninput="changeFormat()" id="jumlah_dpp16" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph16" oninput="changeFormat()" id="jumlah_pph16" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp17" oninput="changeFormat()" id="jumlah_dpp17" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph17" oninput="changeFormat()" id="jumlah_pph17" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp18" oninput="changeFormat()" id="jumlah_dpp18" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph18" oninput="changeFormat()" id="jumlah_pph18" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp19" oninput="changeFormat()" id="jumlah_dpp19" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph19" oninput="changeFormat()" id="jumlah_pph19" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp20" oninput="changeFormat()" id="jumlah_dpp20" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph20" oninput="changeFormat()" id="jumlah_pph20" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp21" oninput="changeFormat()" id="jumlah_dpp21" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph21" oninput="changeFormat()" id="jumlah_pph21" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp22" oninput="changeFormat()" id="jumlah_dpp22" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph22" oninput="changeFormat()" id="jumlah_pph22" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp23" oninput="changeFormat()" id="jumlah_dpp23" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph23" oninput="changeFormat()" id="jumlah_pph23" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp24" oninput="changeFormat()" id="jumlah_dpp24" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph24" oninput="changeFormat()" id="jumlah_pph24" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp25" oninput="changeFormat()" id="jumlah_dpp25" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph25" oninput="changeFormat()" id="jumlah_pph25" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp26" oninput="changeFormat()" id="jumlah_dpp26" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph26" oninput="changeFormat()" id="jumlah_pph26" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp27" oninput="changeFormat()" id="jumlah_dpp27" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph27" oninput="changeFormat()" id="jumlah_pph27" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp28" oninput="changeFormat()" id="jumlah_dpp28" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_pph28" oninput="changeFormat()" id="jumlah_pph28" placeholder="0" style="width: 60%;">
                          </div>
                          ...
                          <div class="col-3" style="padding: 5px">
                            <input type="text" name="jumlah_dpp29" oninput="changeFormat()" id="jumlah_dpp29" placeholder="0" style="width: 60%; margin: 0px 0px 0px 45px">
                          </div>
                          <div class="col-3" style="padding: 5px"> 
                            <input type="text" name="jumlah_pph29" oninput="changeFormat()" id="jumlah_pph29" placeholder="0" style="width: 60%;">
                          </div>
                        </div>
                      </div>
                    </div>
...
function simpan1() {
  ...
  function changeFormat() {
    const jumlah_dpp1 = document.getElementById("jumlah_dpp1");
    // const myElement2 = document.getElementById("jumlah_setor");
    document.getElementById("jumlah_dpp1").value = numeral(jumlah_dpp1).format();
